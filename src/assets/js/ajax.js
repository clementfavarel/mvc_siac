...
function addLike(oeuvreId) {
    ...
    xhr.onerror = function () {
        console.error('Erreur réseau lors de la tentative d\'envoi de la requête');
    ...
    xhr.send('oeuvre_id=' + encodeURIComponent(oeuvreId));
}
...
document.getElementById('add-like-btn').addEventListener('click', function () {
    addLike(123); // Remplacer '123' par l'ID de l'œuvre réel
});
